...
async updateData(message: any) {
      ...
      this.dataModal.image = this.dataModal.image.replace(/^data:image\/[a-zA-Z]+;base64,/, '');
       ...
       if (message === 'Movies') {
        this.movieService.updateMovie(this.dataModal.id, this.dataModal);
      } else if (message === 'Series') {
        this.seriesService.updateSerie(this.dataModal.id, this.dataModal);
      } else if (message === 'Animes') {
        this.animeService.updateSeasonAnime(this.dataModal.id, this.dataModal);
      } else if (message === 'Games') {
        this.gameService.updateGames(this.dataModal.id, this.dataModal);
      } else if (message === 'Books') {
        this.libroService.updateBook(this.dataModal.id, this.dataModal);
      } else if (message === 'Music') {
        this.musicService.updateMusic(this.dataModal.id, this.dataModal);
      }
